...
NAME
----
srcom-trans - an opacity setter tool

SYNOPSIS
--------

*srcom-trans* [-w _WINDOW_ID_] [-n _WINDOW_NAME_] [-c] [-s] _OPACITY_

DESCRIPTION
-----------

*srcom-trans* is a bash script that sets __NET_WM_WINDOW_OPACITY_ attribute of a window using standard X11 command-line utilities, including *xprop*(1) and *xwininfo*(1). It is similar to *transset*(1) or *transset-df*(1).
...
SEE ALSO
--------
xref:srcom.1.adoc[*srcom*(1)], *xprop*(1), *xwininfo*(1)
